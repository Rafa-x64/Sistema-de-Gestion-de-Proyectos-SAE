...
?>
    ...
    public function validar_inicio_sesion($correo, $contraseña): bool
    {
        ...
        if ($verificacion && $correo == $verificacion["correo"] && $contraseña == $verificacion["contraseña"]) {
            ...
            $this->notificacion_error("usuario o contraseña incorrectos", "login", "", "../views/login.php");
...
<?php
            ...
            $this->notificacion_error("no se pudo extraer los datos del usuario", "configuracion", $e->getMessage(), "../views/configuracion_cuenta.php");
        }
    }
