...
<div class="container mt-5">
    ...
    <form action="../controller/editar_admin_controller.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="fecha" name="fecha" value="<?php echo $array["fecha"]; ?>">
        </div>
        <div class="form-group">
            <label for="programador">Programador:</label>
            <input type="text" class="form-control" id="programador" name="programador" value="<?php echo $array["programador"]; ?>">
        </div>
        <div class="form-group">
            <label for="estado">Estado:</label>
            <select class="form-control" id="status" name="estado">
                <option value="En Espera" <?php if ($array["status"] == 'En Espera') echo 'selected'; ?>>En Espera</option>
                <option value="Asignado" <?php if ($array["status"] == 'Asignado') echo 'selected'; ?>>Asignado</option>
                <option value="En Proceso" <?php if ($array["status"] == 'En Proceso') echo 'selected'; ?>>En Proceso</option>
                <option value="Terminado" <?php if ($array["status"] == 'Terminado') echo 'selected'; ?>>Terminado</option>
            </select>
        </div>
        <div class="form-group">
