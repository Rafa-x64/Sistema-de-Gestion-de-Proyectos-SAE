                        ...
                        <div class="container ">
                            <div>
                                <button type="button" class="btn btn-success">
                                    <a class="text-decoration-none text-white" href="views/registro.php">Registrarme</a>
                                </button>
                            </div>
                        </div>
                    </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="newsletter">
                        <p>En <strong>AsistEscolar</strong> nos enfocamos en cumplir los requerimientos de instituciones educativas,
                            públicas y privadas, con diseños e implementación de sistemas; con interfaz amigable,
                            y en el establecimiento de un buen equipo, mecanismos para asistencia y soporte técnico de primera.
                            Nuestros sistemas son autoadministrables y autoconfigurables,
                            brindan respuestas a requerimientos de la comunidad educativa (estudiantes, representantes, profesores, instituciones y más)
                            rápidamente con solo un clic.</p>
                    </div>
                </div>
                <div class="col-lg-3">
